...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        #                                           configs.dropout)
        self.enc_embedding = DataEmbedding_wo_pos_tem(configs.enc_in, configs.d_model, configs.embed, configs.freq,
                                                  configs.dropout)
        self.dec_embedding = DataEmbedding_wo_pos_tem(configs.dec_in, configs.d_model, configs.embed, configs.freq,
                                                  configs.dropout)
    ...
    def forward(self, x_enc, enc_self_mask=None,
        ...
        seasonal_part, trend_part, kl = self.decoder(dec_out, enc_out, x_mask=dec_self_mask, cross_mask=dec_enc_mask,
                                                 trend=trend_init)
        # final
